...
function ThreeSixtyPlayer() {
  ...
  this.config = {
		  ...
		  autoPlay: false,
		  allowMultiple: false,
		  loadRingColor: '#181818',
		  playRingColor: '#090909',
  ...
  this.getUIHTML = function(diameter) {
    ...
    return [
     ...
     ' <div class="sm2-timing'+(navigator.userAgent.match(/safari/i)?' alignTweak mycolor':'')+'"></div>', // + Ever-so-slight Safari horizontal alignment tweak
